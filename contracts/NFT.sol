...
contract RegAI_StakingPass is ERC721Enumerable, Ownable {
    ...
    AggregatorV3Interface internal priceFeed;
        ...
        struct Data{
            ...
            uint indirect_quantity;
            uint indirect_amount;
            uint indirect_reward;
    ...
    function sendRewardToReferrals(address investor,uint _investedAmount)  internal 
        { 
            ...
            percentage[0] = 25 ether;
            percentage[1] = 15 ether;
            percentage[2] = 10 ether;
            
            uint[] memory level_sale = new uint[](4);
            level_sale[0] = 0;
            level_sale[1] = 11;
            level_sale[2] = 26;
            level_sale[3] = 0;
    ...
    function getLatestPrice() public view returns (int) {
        ...
        function getConversionRate(int dollar_amount) public view returns (int) {
            ...
            int BNBPrice = getLatestPrice();
            int UsdToBNB = (( dollar_amount *10**18 ) / (BNBPrice));

            return UsdToBNB;

        }

        function get_BNBPrice()  public view returns(uint ){
            uint price;
            price = uint256(getConversionRate( int256(Pass_price_Dollar)));
    ...
    function set_Pass_price_Dollar(uint256 _newCost) public onlyOwner
    {
